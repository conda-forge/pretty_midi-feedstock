...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pretty_midi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13671&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pretty_midi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pretty_midi` can be installed with:

```
conda install pretty_midi
```

It is possible to list all of the versions of `pretty_midi` available on your platform with:
